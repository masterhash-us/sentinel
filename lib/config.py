...
sentinel_cfg = SarosConfig.tokenize(sentinel_config_file)
sentinel_version = "1.1.0"
min_sarosd_proto_version_with_sentinel_ping = 70207


def get_saros_conf():
    home = os.environ.get('HOME')

    saros_conf = os.path.join(home, ".saroscore/saros.conf")
    if sys.platform == 'darwin':
        saros_conf = os.path.join(home, "Library/Application Support/SarosCore/saros.conf")

    saros_conf = sentinel_cfg.get('saros_conf', saros_conf)
