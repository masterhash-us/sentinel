...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to sarosd "gobject list" output
    ...
    def sarosd_serialise(self):
        import saroslib
        return saroslib.SHIM_serialise_for_sarosd(self.serialise())
